...
export function renderFinishedMatchPage({ match, home, away, matches, teamDirectory, playerDirectory, playerStatistics, competition, selectedMatchTab = "info" }) {
  ...
  content.append(activeTab === "lineup" ? lineupTab(context) : activeTab === "stats" ? createNotice("スタッツ表示は準備中です。") : activeTab === "standings" ? createNotice("順位・大会表示は準備中です。") : activeTab === "head-to-head" ? createNotice("対戦成績は準備中です。") : informationTab(context));
  page.append(
